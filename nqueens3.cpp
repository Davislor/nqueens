...
//    static vector< vector< internal > > attack_matrix;
...
//  vector< vector< bitfield > > board< N, bitfield >::attack_matrix (N*(N-1));
 ...
 */
        for ( ; j >= i; j -= N )
        {
          ...
          attacks.push_back( internal(bottom_row) );
...
// For the degenerate case N == 1, we need a trivial handler:
template < >
...
template < >
  long solve_queens< 1, uint_fast > (void)
  {
    return 1;
  }
...
long queens( unsigned n )
{
  switch (n)
  {
//  Enable these lines to optimize for memory footprint.
...
/*
//  These lines don't actually seem to be faster.

    case  1: return solve_queens<  1, uint_fast > (); break;
    case  2: return solve_queens<  2, uint_fast > (); break;
    case  3: return solve_queens<  3, uint_fast > (); break;
    case  4: return solve_queens<  4, uint_fast > (); break;
    case  5: return solve_queens<  5, uint_fast > (); break;
    case  6: return solve_queens<  6, uint_fast > (); break;
    case  7: return solve_queens<  7, uint_fast > (); break;
    case  8: return solve_queens<  8, uint_fast > (); break;
    case  9: return solve_queens<  9, uint_fast > (); break;
    case 10: return solve_queens< 10, uint_fast > (); break;
    case 11: return solve_queens< 11, uint_fast > (); break;
    case 12: return solve_queens< 12, uint_fast > (); break;
    case 13: return solve_queens< 13, uint_fast > (); break;
    case 14: return solve_queens< 14, uint_fast > (); break;
    case 15: return solve_queens< 15, uint_fast > (); break;
    case 16: return solve_queens< 16, uint_fast > (); break;
    case 17: return solve_queens< 17, uint_fast > (); break;
*/
...
//  static const unsigned start = 17;
